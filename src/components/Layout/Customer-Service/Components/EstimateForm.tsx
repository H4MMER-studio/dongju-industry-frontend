...
const EstimateForm: React.FC<Iprops> = ({ inquiryType, clickSubmit, closeForm }) => {
            ...
            <ContentsLayout>
                <Layout>
                    ...
                    <Layouts>
                        ...
                        />
                        {isCheckValue && !form.inquiry_title && <WarningMessage>답변을 입력해주세요.</WarningMessage>}
                    </Layouts>
                </Layout>
                <Layout>
                    <InputBoxLayout>
                ...
                <Layout>
                    <InputBoxLayout>
                        ...
                        />
                        {isCheckValue && !form.inquiry_email && <WarningMessage>답변을 입력해주세요.</WarningMessage>}
                    </InputBoxLayout>
                    <SelectBoxLayout>
                        <SelectBox
                            type="제품"
                            selectedProduct={
                                PRDUCT_LIST.find((product) => product.type === form.inquiry_product_type)?.name
                            }
                            onClick={(productType) => {
                ...
                <TextAreaLayout>
                    ...
                    />
                    {isCheckValue && !form.inquiry_content && <WarningMessage>답변을 입력해주세요.</WarningMessage>}
                </TextAreaLayout>
                <ButtonLayout>
